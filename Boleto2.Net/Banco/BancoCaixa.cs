    ...
    internal sealed class BancoCaixa : IBanco
    {
        ...
        private string GerarHeaderRemessaCNAB400(int numeroArquivoRemessa, ref int numeroRegistroGeral)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0031, 007, 0, Cedente.Codigo, '0');
        ...
        private string GerarDetalheRemessaCNAB400Registro1(Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0018, 003, 0, "0", '0');
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0021, 007, 0, "007", '0');
                ...
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0077, 001, 0, Empty, ' ');
                reg.Adicionar(TTiposDadoEDI.ediDataDDMMAA___________, 0078, 006, 0, boleto.DataJuros, '0');
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0084, 001, 0, "0", ' ');
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0085, 022, 0, Empty, ' ');
                ...
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0392, 002, 0, "00", '0');
