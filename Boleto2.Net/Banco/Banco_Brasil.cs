...
namespace Boleto2Net
{
    internal class Banco_Brasil : AbstractBanco, IBanco
    {
        internal Banco_Brasil()
        {
            ...
            this.IdsRegistroDetalheCnab400.Add("7");
        }
        ...
        public override void ValidaBoleto(Boleto boleto)
        {
            ...
            switch (boleto.SiglaEspecieDocumento)
            {
                ...
                case "NP":
                    ...
                    break;
                case "ND":
                    boleto.CodigoEspecieDocumento = "13";
                    break;
                case "DS":
        ...
        public override void FormataNossoNumero(Boleto boleto)
        {
            ...
            {
                FormataNossoNumeroCarteira11019(boleto);
            }
            else if (boleto.Banco.Cedente.ContaBancaria.CarteiraComVariacao == "17/019")
            {
                FormataNossoNumeroCarteira17019(boleto);
            }
            else
            {
        ...
        private static void FormataNossoNumeroCarteira11019(Boleto boleto)
        {
        ...
        private static void FormataNossoNumeroCarteira17019(Boleto boleto)
        {
                                            ...
                                            int numeroRegistroCobrancaDescontada, decimal valorCobrancaDescontada)
        {
            try
            {
                ...
                switch (tipoArquivo)
                {
                    case TipoArquivo.CNAB240:
                        // Trailler do Lote
                        _trailer += GerarTrailerLoteRemessaCNAC240(ref numeroRegistroGeral);
                        // Trailler do Arquivo
        ...
        private string GerarDetalheRemessaCNAB400Registro7(Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0002, 002, 0, boleto.Banco.Cedente.Tipo1CPF2CNPJ, '0');
            ...
            try
            {
                ...
                switch (registro.Substring(80, 1))
                {
                    ...
                    case "4":
                        ...
                        break;
                    case "7":
                        // BB - 7 indica que é Cobrança Simples Carteira 17
                        boleto.Banco.Cedente.ContaBancaria.TipoCarteira = TipoCarteira.CarteiraCobrancaSimples;
                        break;
                    case "8":
                ...
                boleto.DescricaoOcorrencia = OcorrenciaCnab400BancoBrasil(boleto.CodigoOcorrencia);
        ...
        private string OcorrenciaCnab400BancoBrasil(string codigo)
        {
            switch (codigo)
            {
                case "02":
