...
{
    [CarteiraCodigo("17/027")]
    internal class BancoBrasilCarteira17_027 : ICarteira<BancoBrasil>
    {
        internal static Lazy<ICarteira<BancoBrasil>> Instance { get; } = new Lazy<ICarteira<BancoBrasil>>(() => new BancoBrasilCarteira17_027());

        private BancoBrasilCarteira17_027()
        {
        ...
        {
            // Carteira 17 - Variação 027: Cliente emite o boleto
