...
{
    [CarteiraCodigo("2")]
    internal class BancoSafraCarteira2 : ICarteira<BancoSafra>
    {
        internal static Lazy<ICarteira<BancoSafra>> Instance { get; } = new Lazy<ICarteira<BancoSafra>>(() => new BancoSafraCarteira2());

        private BancoSafraCarteira2()
        {
