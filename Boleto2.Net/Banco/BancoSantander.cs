    ...
    internal sealed class BancoSantander : IBanco
    {
        ...
        private string GerarHeaderRemessaCNAB400(int numeroArquivoRemessa, ref int numeroRegistroGeral)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0027, 020, 0, Cedente.CodigoTransmissao, '0');
                ...
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0392, 003, 0, "0", '0');
